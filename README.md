...
`sh -c "$(curl -fsSL https://raw.github.com/lumir-mrkva/oh-my-zsh/master/tools/install.sh)"`

#### via wget

`sh -c "$(wget https://raw.github.com/lumir-mrkva/oh-my-zsh/master/tools/install.sh -O -)"`
